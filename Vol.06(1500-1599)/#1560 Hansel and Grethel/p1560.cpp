// 1665729 2008-10-14 00:42:44 Accepted  1560 C++ 0 184 呆滞的慢板 

// 知道点 p1 p2 的坐标以及相对于 p 的角度，求 p 的坐标。
// 用点斜式得到两直线方程，再求交点即可。 
...
int main() {
    for(cin >> T; T--;) {
        cin >> p1 >> a1 >> p2 >> a2;
        l1 = Line(p1, p1+Point(sin(PI*a1/180.0), cos(PI*a1/180.0)));
        l2 = Line(p2, p2+Point(sin(PI*a2/180.0), cos(PI*a2/180.0)));
        p = intersect(l1, l2);
        printf("%.4lf %.4lf\n", p.x, p.y);
    }
}
