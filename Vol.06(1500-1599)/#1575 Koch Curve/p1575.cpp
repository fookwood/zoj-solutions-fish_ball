// 1891627 2009-06-05 14:46:43 Accepted  1575 C++ 80 1040 呆滞的慢板 

// 普通的分形模拟，怎么搞都行。 

//////////////////////////////////////////////////////////////////////////
//                     Geometric class, Version 2.2                     //
//////////////////////////////////////////////////////////////////////////
//                                                                      //
//  V2.0(2008-9-16):                                                    // 
...
//////////////////////////////////////////////////////////////////////////
//                     Geometric class, Version 2.2                     //
//                   Powered by ELF, Copyright(c) 2009                  //
//////////////////////////////////////////////////////////////////////////
    ...
    while(cin >> n >> a >> b) {
        ...
        while(n--) {
            ...
            for(int i = 1; i < V.size(); ++i) {
                Point a = V[i-1], b = V[i];
                W.push_back((2.0*a+b)/3.0);
                W.push_back((b+a)/2.0+(~(b-a))*Q3);
                W.push_back((a+2.0*b)/3.0);
                W.push_back(b);
            }
            V = W;
        }
