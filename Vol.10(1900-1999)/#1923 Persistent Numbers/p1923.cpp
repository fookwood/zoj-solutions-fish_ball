// 3014139 2008-07-30 16:55:57 Accepted 1923 C++ 00:00.09 864K 呆滞的慢板 

// 实际上就是求一个大数最少个数的因式分解 
// 因式在 2~9，因此注意次序，如下 P[8] 的次序 
...
int main() {
    ...
    while( cin.peek() != '-' ) {
        ...
        if( X == 0 ) { puts( "10" ); continue; }
        if( X == 1 ) { puts( "11" ); continue; }
