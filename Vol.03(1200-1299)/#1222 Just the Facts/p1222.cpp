// 1652472 2008-09-30 23:38:30 Accepted  1222 C++ 110 2236 呆滞的慢板 

// 超级经典的数论题，输入的 n 光位数可以到 100 
...
int D[10] = {0, 0, 6, 0, 2, 0, 8, 0, 4, 0};

int eval(const BigNum& N) {
    if(N < 10) return F[N%10];
    int ans = eval(N/5) * 6 * T[N%10] % 10;
    for(int n = N/5%4; n--;)
        ans = D[ans];
    return ans;
}
